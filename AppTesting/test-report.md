...
11.  | Некорректный формат фамилии при добавлении сотрудника |Не пройден | Предупреждение не отображается. Фамилия занесено в базу данных. |
...
13.  | Некорректный формат даты рождения                     |Не пройден | Сообщение не отображается. Дата занесена в базу данных в некорректном формате: Сегодняшняя дата. |
